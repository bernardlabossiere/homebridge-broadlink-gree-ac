...
export class MatterBridgeManager extends BaseMatterManager {
    ...
    _onRegisterMatterPlatformAccessoriesDropped = (pluginIdentifier, _platformName, accessories) => {
    ...
    _onUnregisterMatterPlatformAccessoriesDropped = (pluginIdentifier, _platformName, accessories) => {
    ...
    setupBridgedDropStubs() {
        ...
        this.api.on("registerMatterPlatformAccessories" /* InternalAPIEvent.REGISTER_MATTER_PLATFORM_ACCESSORIES */, this._onRegisterMatterPlatformAccessoriesDropped);
        this.api.on("unregisterMatterPlatformAccessories" /* InternalAPIEvent.UNREGISTER_MATTER_PLATFORM_ACCESSORIES */, this._onUnregisterMatterPlatformAccessoriesDropped);
    ...
    async teardown() {
        ...
        this.api.removeListener("registerMatterPlatformAccessories" /* InternalAPIEvent.REGISTER_MATTER_PLATFORM_ACCESSORIES */, this._onRegisterMatterPlatformAccessoriesDropped);
        this.api.removeListener("unregisterMatterPlatformAccessories" /* InternalAPIEvent.UNREGISTER_MATTER_PLATFORM_ACCESSORIES */, this._onUnregisterMatterPlatformAccessoriesDropped);
