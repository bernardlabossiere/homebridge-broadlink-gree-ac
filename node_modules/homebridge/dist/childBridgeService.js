...
(function (ChildProcessMessageEventType) {
     ...
     */
    ChildProcessMessageEventType["RELEASE_MATTER_PORT"] = "releaseMatterPort";
    /**
    ...
    startChildProcess() {
        ...
        this.child.on('message', (message) => {
            ...
            switch (message.id) {
                ...
                case "releaseMatterPort" /* ChildProcessMessageEventType.RELEASE_MATTER_PORT */: {
                ...
                case "matterEvent" /* ChildProcessMessageEventType.MATTER_EVENT */: {
                    ...
                    if (matterEvent.type === 'accessoriesData') {
                        ...
                        if (matterEvent.type === 'accessoryInfoData' && this.onAccessoryInfoResponse) {
                            const uuid = matterEvent.data?.uuid;
                            if (uuid) {
