...
import type { AccessoryConfig, BridgeConfiguration, BridgeHapConfig, BridgeOptions, HomebridgeConfig, PlatformConfig } from './bridgeService.js';
...
export declare class ChildBridgeService {
    ...
    private matterAccessoriesPromise?;
    onExternalBridgeRegistered?: (externalBridgeUsername: string, ownerUsername: string) => void;
    onAccessoryInfoResponse?: (uuid: string) => void;
    private readonly _onApiShutdown;
