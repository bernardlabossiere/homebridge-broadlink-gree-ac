...
export class ChildBridgeFork {
    ...
    async loadPlugin(data) {
        ...
        // is suppressed.
        if (isMatterActive(this.bridgeConfig.matter) && this.type !== "accessory" /* PluginType.ACCESSORY */) {
     ...
     */
    releaseMatterPort(uniqueId) {
        this.sendMessage("releaseMatterPort" /* ChildProcessMessageEventType.RELEASE_MATTER_PORT */, { uniqueId });
    }
    /**
