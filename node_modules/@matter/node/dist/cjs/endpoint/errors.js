...
__export(errors_exports, {
  AttributeNotPresentError: () => AttributeNotPresentError,
  BehaviorInitializationError: () => BehaviorInitializationError,
  EndpointBehaviorNotClusterError: () => EndpointBehaviorNotClusterError,
  EndpointBehaviorNotPresentError: () => EndpointBehaviorNotPresentError,
  EndpointBehaviorsError: () => EndpointBehaviorsError,
  EndpointPartsError: () => EndpointPartsError,
  EndpointReadFailedError: () => EndpointReadFailedError,
...
class EndpointBehaviorNotPresentError extends import_general.MatterError {
  constructor(behaviorId) {
    super(`Behavior "${behaviorId}" is not present on this endpoint`);
  }
}
class EndpointBehaviorNotClusterError extends import_general.MatterError {
  constructor(behaviorId) {
    super(`Behavior "${behaviorId}" is present but is not a cluster behavior`);
  }
}
class AttributeNotPresentError extends import_general.MatterError {
  constructor(behaviorId, attributeName) {
    super(`Attribute "${attributeName}" is not present on behavior "${behaviorId}"`);
  }
}
class EndpointReadFailedError extends import_general.MatterError {
  failed;
  partial;
  constructor(detail) {
