...
class LevelControlBaseServer extends LevelControlBase {
  ...
  initialize() {
    if (this.state.minLevel === void 0) {
      this.state.minLevel = this.features.lighting ? 1 : 0;
    }
    if (this.state.maxLevel === void 0) {
  ...
  #assertRateValue(rate) {
    if (rate === 0) {
      throw new import_types.StatusResponseError(`Illegal move rate of 0`, import_types.Status.InvalidCommand);
    }
    if (rate === null) {
