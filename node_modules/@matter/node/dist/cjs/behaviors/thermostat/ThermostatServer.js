...
var import_thermostat = require("@matter/types/clusters/thermostat");
...
class ThermostatBaseServer extends ThermostatBehaviorLogicBase {
  ...
  async initialize() {
    ...
    if (!this.features.presets && !this.features.matterScheduleConfiguration) {
      this.atomicRequest = import_Behavior.Behavior.unimplemented;
    }
        ...
        Object.defineProperty(properties, "presets", {
          ...
          get() {
            const pendingValue = endpoint.env.get(import_AtomicWriteHandler.AtomicWriteHandler).pendingValueForAttributeAndPeer(
              ...
              endpoint,
              ThermostatBaseServer2,
              import_thermostat.Thermostat.attributes.presets.id
            );
...
class ThermostatServer extends ThermostatBaseServer.for(import_thermostat.Thermostat) {
}
