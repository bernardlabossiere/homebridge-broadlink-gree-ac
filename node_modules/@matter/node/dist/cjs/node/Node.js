  ...
  async startWithMutex() {
    ...
    try {
      ...
      if (this.#runtime) {
        ...
        this.#environment.delete(import_NetworkRuntime.NetworkRuntime, runtime);
        this.#runtime = void 0;
        this.behaviors.internalsOf(import_NetworkBehavior.NetworkBehavior).runtime = void 0;
        runtime.close().catch((e2) => {
          logger.warn("Error closing network runtime", (0, import_general.asError)(e2));
        });
      }
