...
((OnOffPlugInUnitRequirements2) => {
  ...
  OnOffPlugInUnitRequirements2.OccupancySensingClient = import_OccupancySensingClient.OccupancySensingClient;
  ...
  OnOffPlugInUnitRequirements2.client = { optional: { OccupancySensing: OnOffPlugInUnitRequirements2.OccupancySensingClient }, mandatory: {} };
})(OnOffPlugInUnitRequirements || (OnOffPlugInUnitRequirements = {}));
