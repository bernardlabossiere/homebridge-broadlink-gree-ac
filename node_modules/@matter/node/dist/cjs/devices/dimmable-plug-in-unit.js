...
((DimmablePlugInUnitRequirements2) => {
  ...
  DimmablePlugInUnitRequirements2.OccupancySensingClient = import_OccupancySensingClient.OccupancySensingClient;
  ...
  DimmablePlugInUnitRequirements2.client = { optional: { OccupancySensing: DimmablePlugInUnitRequirements2.OccupancySensingClient }, mandatory: {} };
})(DimmablePlugInUnitRequirements || (DimmablePlugInUnitRequirements = {}));
