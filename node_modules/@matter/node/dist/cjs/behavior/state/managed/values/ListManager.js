  ...
  writeEntry(index, value, location) {
    if (value === void 0) {
      ...
      if (!(0, import_general.isObject)(value)) {
        throw new import_protocol.WriteError(location, `Fabric scoped list value is not an object`, import_types.Status.Failure);
      }
