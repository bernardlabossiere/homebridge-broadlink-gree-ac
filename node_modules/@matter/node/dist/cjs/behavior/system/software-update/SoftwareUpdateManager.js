...
class SoftwareUpdateManager extends import_Behavior.Behavior {
  ...
  async #checkProductForUpdates(infos, includeStoredUpdates) {
    ...
    if (includeStoredUpdates && [...otaEndpoints.values()].every(({ peerAddress }) => this.internal.knownUpdates.has(peerAddress))) {
  ...
  async forceUpdate(peerAddress, vendorId, productId, targetSoftwareVersion) {
    peerAddress = (0, import_protocol.PeerAddress)(peerAddress);
...
((SoftwareUpdateManager2) => {
  ...
  class Internal {
    ...
    knownUpdates = new import_protocol.PeerAddressMap();
    /**
     ...
     */
    pendingStartUpSuppress = new import_protocol.PeerAddressMap();
    closed = false;
  }
