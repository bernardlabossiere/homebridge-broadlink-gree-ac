...
function adaptError(e) {
  ...
  if (status === void 0) {
    if ((0, import_general.causedBy)(e, import_types.StatusResponseError)) {
      status = 400;
    } else {
      status = 500;
    }
...
function logError(request, response, error) {
  if (response.status >= 500 && response.status < 600) {
    ...
    logger.warn(diagnosticHeaderFor(request, response), import_general.Diagnostic.errorMessage(error));
  } else {
