...
export declare namespace ContentAppRequirements {
     ...
     */
    const ContentAppObserverClient: import("../behaviors/content-app-observer/ContentAppObserverClient.js").ContentAppObserverClientConstructor;
    /**
    ...
    const client: {
        optional: {
            ContentAppObserver: import("../behaviors/content-app-observer/ContentAppObserverClient.js").ContentAppObserverClientConstructor;
        };
        mandatory: {};
    };
}
