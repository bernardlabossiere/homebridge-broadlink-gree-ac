...
import { ClosureDimensionServer as BaseClosureDimensionServer } from "../behaviors/closure-dimension/ClosureDimensionServer.js";
...
export declare namespace ClosurePanelRequirements {
    /**
     ...
     */
    const ClosureDimensionServer: typeof BaseClosureDimensionServer;
    /**
     * An implementation for each server cluster supported by the endpoint per the Matter specification.
     */
    const server: {
        mandatory: {
            ClosureDimension: typeof BaseClosureDimensionServer;
        };
    };
}
export declare const ClosurePanelDeviceDefinition: MutableEndpoint.With<import("../index.js").EndpointType.For<{
    readonly name: "ClosurePanel";
    readonly deviceType: 561;
    readonly deviceRevision: 1;
    readonly requirements: typeof ClosurePanelRequirements;
    readonly behaviors: {};
}>, {}, {}>;
export declare const ClosurePanelDevice: ClosurePanelDevice;
//# sourceMappingURL=closure-panel.d.ts.map