...
export declare namespace ThermostatRequirements {
     ...
     */
    const FanControlClient: import("../behaviors/fan-control/FanControlClient.js").FanControlClientConstructor;
    /**
     * The TemperatureMeasurement cluster is optional per the Matter specification.
     *
     * We provide this alias to the default implementation {@link TemperatureMeasurementClient} for convenience.
     */
    const TemperatureMeasurementClient: import("../behaviors/temperature-measurement/TemperatureMeasurementClient.js").TemperatureMeasurementClientConstructor;
    /**
     ...
     */
    const RelativeHumidityMeasurementClient: import("../behaviors/relative-humidity-measurement/RelativeHumidityMeasurementClient.js").RelativeHumidityMeasurementClientConstructor;
    /**
     * The OccupancySensing cluster is optional per the Matter specification.
     *
     * We provide this alias to the default implementation {@link OccupancySensingClient} for convenience.
     */
    const OccupancySensingClient: import("../behaviors/occupancy-sensing/OccupancySensingClient.js").OccupancySensingClientConstructor;
    /**
    ...
    const client: {
        optional: {
            FanControl: import("../behaviors/fan-control/FanControlClient.js").FanControlClientConstructor;
            TemperatureMeasurement: import("../behaviors/temperature-measurement/TemperatureMeasurementClient.js").TemperatureMeasurementClientConstructor;
            RelativeHumidityMeasurement: import("../behaviors/relative-humidity-measurement/RelativeHumidityMeasurementClient.js").RelativeHumidityMeasurementClientConstructor;
            OccupancySensing: import("../behaviors/occupancy-sensing/OccupancySensingClient.js").OccupancySensingClientConstructor;
        };
        mandatory: {};
    };
}
