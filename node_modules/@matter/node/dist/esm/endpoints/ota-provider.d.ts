...
export declare namespace OtaProviderRequirements {
     ...
     */
    const OtaSoftwareUpdateRequestorClient: import("../behaviors/ota-software-update-requestor/OtaSoftwareUpdateRequestorClient.js").OtaSoftwareUpdateRequestorClientConstructor;
    /**
    ...
    const client: {
        optional: {
            OtaSoftwareUpdateRequestor: import("../behaviors/ota-software-update-requestor/OtaSoftwareUpdateRequestorClient.js").OtaSoftwareUpdateRequestorClientConstructor;
        };
        mandatory: {};
    };
}
