...
export declare namespace OtaRequestorRequirements {
     ...
     */
    const OtaSoftwareUpdateProviderClient: import("../behaviors/ota-software-update-provider/OtaSoftwareUpdateProviderClient.js").OtaSoftwareUpdateProviderClientConstructor;
    /**
    ...
    const client: {
        mandatory: {
            OtaSoftwareUpdateProvider: import("../behaviors/ota-software-update-provider/OtaSoftwareUpdateProviderClient.js").OtaSoftwareUpdateProviderClientConstructor;
        };
    };
}
