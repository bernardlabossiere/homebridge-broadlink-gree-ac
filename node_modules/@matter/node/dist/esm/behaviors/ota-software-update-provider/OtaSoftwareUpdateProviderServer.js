    ...
    if (updateInProgress !== void 0) {
      ...
      if (sessionFromBdxSession === void 0) {
        ...
        await this.endpoint.act(
          (agent) => agent.get(SoftwareUpdateManager).suppressNextStartUp(peerAddress, session.id)
        );
      } else {
        logger.info(
