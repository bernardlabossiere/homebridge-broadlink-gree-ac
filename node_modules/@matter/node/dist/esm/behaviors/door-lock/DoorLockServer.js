...
const DataOperationType = DoorLock.DataOperationType;
const DoorState = DoorLock.DoorState;
const LockDataType = DoorLock.LockDataType;
...
class DoorLockBaseServer extends DoorLockBaseServerClass {
  ...
  setHolidaySchedule(request) {
    ...
    if (request.operatingMode !== DoorLock.OperatingMode.Normal && request.operatingMode !== DoorLock.OperatingMode.Vacation && request.operatingMode !== DoorLock.OperatingMode.Privacy && request.operatingMode !== DoorLock.OperatingMode.NoRemoteLockUnlock && request.operatingMode !== DoorLock.OperatingMode.Passage) {
...
class DoorLockServer extends DoorLockBaseServer.for(DoorLock) {
}
export {
  DoorLockBaseServer,
  DoorLockServer
