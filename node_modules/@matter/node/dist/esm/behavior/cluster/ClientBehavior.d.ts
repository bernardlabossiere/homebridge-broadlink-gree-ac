...
import { clientBrand } from "./cluster-behavior-utils.js";
/**
 ...
 */
export declare function ClientBehavior<const NS extends ClusterType>(ns: NS): ClusterBehavior.Complete<typeof ClusterBehavior, NS> & {
    [k in typeof clientBrand]: true;
};
