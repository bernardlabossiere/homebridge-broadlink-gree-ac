...
import { CancelablePromise, Diagnostic, Logger, MaybePromise, withTimeout } from "@matter/general";
import { ScannerSet } from "@matter/protocol";
...
class Discovery extends CancelablePromise {
  ...
  #performDiscovery() {
    ...
    const { timeout: _, scannerFilter, id, ...identifier } = this.#options;
