...
import { EndpointNumber, FabricIndex, Status } from "@matter/types";
...
class Endpoint {
  ...
  #installedClusterBehavior(type) {
    if (typeof type === "string") {
      ...
      return installed !== void 0 && ClusterBehavior.isType(installed) ? installed : void 0;
    }
  ...
  #resolveClientPeerContext() {
    ...
    if (fallback !== void 0 && fallback !== FabricIndex.NO_FABRIC) {
  ...
  async #performRead(selector, options) {
    ...
    if (node.nodeType === "client") {
      ...
      if (failed.length > 0) {
        ...
        throw new EndpointReadFailedError({ failed, partial: partial2 });
      }
      return partial2;
    }
