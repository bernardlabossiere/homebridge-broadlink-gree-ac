...
__export(TlvObject_exports, {
  ...
  TlvTaggedListPreservingOrder: () => TlvTaggedListPreservingOrder
});
...
class ObjectSchema extends import_TlvSchema.TlvSchema {
  constructor(fieldDefinitions, type = import_TlvCodec.TlvType.Structure, allowProtocolSpecificTags = false, preserveDataOrdering = false) {
    super();
    this.fieldDefinitions = fieldDefinitions;
    this.type = type;
    this.allowProtocolSpecificTags = allowProtocolSpecificTags;
    this.preserveDataOrdering = preserveDataOrdering;
...
const TlvTaggedListPreservingOrder = (fields, allowProtocolSpecificTags = false) => new ObjectSchema(
  fields,
  import_TlvCodec.TlvType.List,
  allowProtocolSpecificTags,
  /* preserveDataOrdering */
  true
);
