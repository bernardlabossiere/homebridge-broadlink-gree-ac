 ...
 */
import { Bytes, Merge } from "@matter/general";
...
export declare class ObjectSchema<F extends TlvFields> extends TlvSchema<TypeFromFields<F>> {
    ...
    private readonly preserveDataOrdering;
    ...
    /** When true, list encoding follows caller property order instead of schema order. See {@link TlvTaggedListPreservingOrder}. */
    preserveDataOrdering?: boolean);
    /** @deprecated Part of old ClusterType() compat layer. */
    get element(): TlvSchema.Element;
 ...
 */
export declare const TlvTaggedListPreservingOrder: <F extends TlvFields>(fields: F, allowProtocolSpecificTags?: boolean) => ObjectSchema<F>;
/**
