...
((SecureMessageType2) => {
  ...
  function isStatusReport(protocolId, messageType) {
    return protocolId === SECURE_CHANNEL_PROTOCOL_ID && messageType === 64 /* StatusReport */;
  }
  SecureMessageType2.isStatusReport = isStatusReport;
