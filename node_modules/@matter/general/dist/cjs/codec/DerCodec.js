...
const DerTag = {
  Sequence: 16 /* Sequence */ | CONSTRUCTED,
  Set: 17 /* Set */ | CONSTRUCTED
};
...
const ObjectId = (objectId) => ({
  ...
  _bytes: typeof objectId === "bigint" ? import_Bytes.Bytes.fromBigInt(objectId) : import_Bytes.Bytes.fromHex(objectId)
});
...
class DerCodec {
  static encode(value) {
    if (Array.isArray(value)) {
      ...
      if (value._tag !== void 0) {
        ...
        if (value._type === 2 /* Integer */ && import_Bytes.Bytes.isBytes(value._raw)) {
      ...
      } else if ("_bytes" in value && value._bytes !== void 0 && import_Bytes.Bytes.isBytes(value._bytes) && Object.keys(value).length === 1) {
        return import_Bytes.Bytes.of(value._bytes);
  ...
  static decodeBigUint(value, byteLength) {
    ...
    if (!import_Bytes.Bytes.isBytes(value._bytes)) {
      throw new DerError("Incorrect DER object type");
    }
    const bytes = import_Bytes.Bytes.of(value._bytes);
  ...
  static #encodeArray(array) {
    return this.#encodeAsn1(DerTag.Set, import_Bytes.Bytes.concat(...array.map((element) => this.encode(element))));
  }
  ...
  static #encodeSequence(object) {
    ...
    return this.#encodeAsn1(DerTag.Sequence, import_Bytes.Bytes.concat(...attributes));
  }
