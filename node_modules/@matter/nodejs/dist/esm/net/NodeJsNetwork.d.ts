 ...
 */
import { Network, NetworkInterface, NetworkInterfaceDetails, TcpConnection, TcpConnectOptions, TcpListener, TcpListenerOptions, UdpSocket, UdpSocketOptions } from "@matter/general";
export declare class NodeJsNetwork extends Network {
    ...
    connectTcp(host: string, port: number, options?: TcpConnectOptions): Promise<TcpConnection>;
}
