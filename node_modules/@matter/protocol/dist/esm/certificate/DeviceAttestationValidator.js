    ...
    if (dclCertificateService === void 0) {
      ...
      if (!paaMetadata.isProduction && !dclCertificateService.acceptsTestCertificates) {
        findings.push({
          ...
          message: `PAA ${Bytes.toHex(paiAkid)} is a test/development certificate; device presented a valid test attestation but production trust policy is in effect`
        });
      }
