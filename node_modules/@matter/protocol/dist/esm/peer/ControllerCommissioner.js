  ...
  async #commissionConnectedNode(ephemeralSession, options, discoveryData) {
    ...
    try {
      ...
      try {
        ...
        fabricIndexOnPeer = captured === FabricIndex.NO_FABRIC ? void 0 : captured;
      } catch (error) {
