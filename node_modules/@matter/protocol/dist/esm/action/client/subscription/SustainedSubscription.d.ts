...
import { AsyncObservableValue, RetrySchedule } from "@matter/general";
...
export declare class SustainedSubscription extends ClientSubscription {
    ...
    get interactionModelRevision(): number | undefined;
...
export declare namespace SustainedSubscription {
     ...
     */
    interface Configuration extends Omit<ClientSubscription.Configuration, "request"> {
