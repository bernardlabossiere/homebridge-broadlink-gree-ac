...
import { ClassExtends, Duration, Environment, Environmental, MaybePromise, ServerAddress, TransportSet } from "@matter/general";
...
export declare class ControllerCommissioner {
     ...
     */
    commission(options: LocatedNodeCommissioningOptions): Promise<CommissionResult>;
    /**
