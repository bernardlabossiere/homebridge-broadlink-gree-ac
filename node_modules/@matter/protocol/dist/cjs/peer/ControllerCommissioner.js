...
class ControllerCommissioner {
  ...
  async #commissionConnectedNode(ephemeralSession, options, discoveryData) {
    ...
    try {
      ...
      let fabricIndexOnPeer;
      try {
        await commissioner.executeCommissioning();
        const captured = commissioner.fabricIndexOnPeer;
        fabricIndexOnPeer = captured === import_types.FabricIndex.NO_FABRIC ? void 0 : captured;
      } catch (error) {
