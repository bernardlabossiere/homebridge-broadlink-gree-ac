...
__export(ClientInteraction_exports, {
  ...
  inferLargeMessage: () => inferLargeMessage
});
module.exports = __toCommonJS(ClientInteraction_exports);
var import_Invoke = require("#action/request/Invoke.js");
var import_MalformedRequestError = require("#action/request/MalformedRequestError.js");
...
function inferLargeMessage(request) {
  for (const cmd of request.commands.values()) {
    ...
    try {
      ...
      import_MalformedRequestError.MalformedRequestError.accept(error);
    }
  }
  return false;
}
...
class ClientInteraction {
  ...
  async *invoke(request, session) {
    if (request.largeMessage === void 0 && inferLargeMessage(request)) {
