      ...
      for (const retry of this.#retries) {
        try {
          ...
          if (bootstrapWithRead) {
            const response = this.#read(request, this.abort, import_general.Diagnostic.asFlags({ bootstrap: true }));
            if (request.updated) {
          ...
          if (!(0, import_general.causedBy)(e, import_general.AbortedError) || !this.abort.aborted) {
            sessionTrusted = true;
            logger.info(
