...
export declare class DclCertificateService {
     ...
     */
    getCertificate(subjectKeyId: Bytes | string, options?: DclCertificateService.GetCertificateOptions): DclCertificateService.CertificateMetadata | undefined;
    /**
     ...
     */
    getCertificateAsPem(subjectKeyId: Bytes | string, options?: DclCertificateService.GetCertificateOptions): Promise<string>;
    /**
     * Get certificate as DER bytes.
     * @throws {MatterDclError} if certificate not found or filtered by trust policy
     */
    getCertificateAsDer(subjectKeyId: Bytes | string, options?: DclCertificateService.GetCertificateOptions): Promise<Uint8Array<ArrayBufferLike>>;
    /**
    ...
    } & DclCertificateService.GetCertificateOptions): Promise<DclCertificateService.CertificateMetadata | undefined>;
    /**
