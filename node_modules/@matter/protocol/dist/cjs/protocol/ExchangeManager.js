...
class ExchangeManager {
  ...
  #handleIncomingMessageError(what, error, exchange, message) {
    ...
    logger.warn(import_MessageCodec.Message.via(exchange, message), "Unhandled error handling incoming message:", error);
  }
