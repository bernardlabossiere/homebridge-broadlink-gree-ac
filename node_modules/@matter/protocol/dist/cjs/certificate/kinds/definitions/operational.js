...
const TlvCertificateExtension = (0, import_types.TlvTaggedListPreservingOrder)({
...
((OperationalCertificate2) => {
  ...
  const TlvGenericMatterSubjectOrIssuerTaggedList = (matterFields) => {
    ...
    return (0, import_types.TlvTaggedListPreservingOrder)(fields);
  };
  const BaseMatterCertificate = (matterFields) => (0, import_types.TlvObjectWithMaxSize)(
    {
      ...
      serialNumber: (0, import_types.TlvField)(1, import_types.TlvByteString),
