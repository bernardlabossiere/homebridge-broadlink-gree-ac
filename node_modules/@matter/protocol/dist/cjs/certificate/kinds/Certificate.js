...
((Certificate2) => {
  ...
  function parseAsn1Certificate(encodedCert, requiredExtensions = Certificate2.REQUIRED_EXTENSIONS) {
    ...
    const tbsDer = import_general.Bytes.of(import_general.DerCodec.encode(certificateNode));
    ...
    idx++;
    const issuerDer = import_general.Bytes.of(import_general.DerCodec.encode(certElements[idx]));
  ...
  async function getPublicKeyFromCsr(crypto, encodedCsr) {
    ...
    if (subjectNode._tag !== import_general.DerTag.Sequence) {
