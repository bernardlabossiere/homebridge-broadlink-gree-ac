...
class BdxSession {
  ...
  async processTransfer() {
    ...
    try {
      ...
      transferError = error;
      if (import_BdxError.BdxError.is(error)) {
        await this.#messenger.sendError(error.code).catch((sendError) => {
          logger.info(`Failed to send BDX error status to peer:`, import_general.Diagnostic.errorMessage(sendError));
        });
