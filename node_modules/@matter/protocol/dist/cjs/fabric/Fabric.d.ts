...
import { AsyncObservable, BinaryKeyPair, Bytes, Crypto, Key, MatterError, MaybePromise, PrivateKey, StorageContext } from "@matter/general";
...
export declare class Fabric {
    ...
    sign(data: Bytes): MaybePromise<import("@matter/general").EcdsaSignature>;
